...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const res = await fetch(`${baseUrl}/hunt/${params.id}/participants`, {
      method: 'GET',
      mode: 'cors',
      headers: {
    ...
    const { data } = response as SuccessResponse<HuntParticipant[]>
